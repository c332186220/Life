...
import com.cxl.life.util.ColorUtil;
...
public class CustomItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<KingGlory> mBeans;
    private static final int dividerHeight = 80;
    private Context mContext;
    private final Rect mBounds = new Rect();
    private String tagsStr;

    public void setDatas(List<KingGlory> mBeans, String tagsStr) {
        this.mBeans = mBeans;
     ...
     */
    private void drawTitleBar(Canvas canvas, RecyclerView parent, View child, KingGlory bean, int position) {
        final int left = 0;
        ...
        canvas.drawCircle(ScreenUtil.dpTopx(mContext, 42.5f), bottom - dividerHeight / 2, 35, mPaint);
        mPaint.setColor(Color.WHITE);
        canvas.drawText(bean.getIndexTag(), ScreenUtil.dpTopx(mContext, 42.5f), bottom - dividerHeight / 3, mPaint);
    }
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        canvas.drawCircle(ScreenUtil.dpTopx(mContext, 42.5f), bottom - dividerHeight / 2, 35, mPaint);
        mPaint.setColor(Color.WHITE);
        canvas.drawText(mBeans.get(position).getIndexTag(), ScreenUtil.dpTopx(mContext, 42.5f), bottom - dividerHeight / 3, mPaint);
    }
