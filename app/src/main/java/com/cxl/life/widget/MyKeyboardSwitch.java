...
public class MyKeyboardSwitch extends EditText implements KeyboardView.OnKeyboardActionListener {
    ...
    private Keyboard mKeyboard, keyboard;//数字   字母键盘
    ...
    public boolean isnun = true;// 是否字母键盘

    public MyKeyboardSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initKeyboard(Context context) {
        mKeyboard = new Keyboard(context, R.xml.symbols_a1);
        keyboard = new Keyboard(context, R.xml.symbols_abc);
