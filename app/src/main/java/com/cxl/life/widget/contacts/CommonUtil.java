...
public class CommonUtil {
     ...
     */
    public static void sortData(List<KingGlory> list) {
        if (list == null || list.size() == 0) return;
        for (int i = 0; i < list.size(); i++) {
            KingGlory bean = list.get(i);
        ...
        Collections.sort(list, new Comparator<KingGlory>() {
            @Override
            public int compare(KingGlory o1, KingGlory o2) {
     ...
     */
    public static String getTags(List<KingGlory> beans) {
