...
public class KingRecyclerGridAdapter extends RecyclerView.Adapter {
    ...
    public KingRecyclerGridAdapter(Context context, List<KingGlory> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.king_recycler_grid_item, parent, false);
