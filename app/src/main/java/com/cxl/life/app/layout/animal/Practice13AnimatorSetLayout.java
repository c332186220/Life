 ...
 * 动画连续执行
 */
public class Practice13AnimatorSetLayout extends RelativeLayout {
    View view;
    Button animateBt;

    public Practice13AnimatorSetLayout(Context context) {
        super(context);
    }

    public Practice13AnimatorSetLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Practice13AnimatorSetLayout(Context context, AttributeSet attrs, int defStyleAttr) {
