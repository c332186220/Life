package com.cxl.life.app.function.popup;
...
import com.cxl.life.adapter.PopupAdapter;
...
import com.cxl.life.dialog.CommonPopupWindow;
import com.cxl.life.util.CommonUtil;
import com.cxl.life.util.ScreenUtil;

public class PopupWindowActivity extends BaseTitleActivity implements CommonPopupWindow.ViewInterface {
...
//        popupWindow.showAtLocation(findViewById(android.R.id.content), Gravity.NO_GRAVITY, positions[0], positions[1] - popupWindow.getHeight());
    ...
    public void showReminder(View view) {
        ...
        popupWindow = new CommonPopupWindow.Builder(this)
                ...
                .setWidthAndHeight(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT)
                .create();
        popupWindow.showAsDropDown(view, -popupWindow.getWidth() + ScreenUtil.dpTopx(this, 20), -(popupWindow.getHeight() + view.getMeasuredHeight()));
    }
